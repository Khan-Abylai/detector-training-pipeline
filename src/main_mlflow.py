...
def train(gpu, args):
    ...
    with mlflow.start_run(run_name='detector train') as run:
        if gpu == 0:
        ...
        for epoch in range(start_epoch, args.num_epochs):
            ...
            for idx, (images, plate_boxes) in enumerate(progress_bar):
                ...
                if i == len(train_dataloader):
                    ...
                    if gpu == 0:
                        ...
                        mlflow.log_metric("train loss", train_mean_loss, step=idx)
                        mlflow.log_metric("val loss", val_mean_loss, step=idx)
