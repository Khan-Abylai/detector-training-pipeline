...
parser.add_argument('--weights_path', type=str, default='../weights/detector_sng_europe.pth')
parser.add_argument('--out_path', type=str, default='../weights/detector_sng_europe.np')
