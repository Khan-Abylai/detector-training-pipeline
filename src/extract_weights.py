...
parser.add_argument('--weights_path', type=str, default='../weights/detector_weights_new_uae.pth')
parser.add_argument('--out_path', type=str, default='../weights/detector_weights_new_uae.np')
